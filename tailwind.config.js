  ...
  theme: {
    ...
    extend: {
      colors: {
        /* Base colors */
        primary: {
          DEFAULT: "#52aaa5", // var(--primary)
          foreground: "var(--primary-foreground)",
          hover: "#3d8984", // var(--primary-dark)
          light: "#7bc4bf", // var(--primary-light)
        },

        /* Background colors */
        background: {
          primary: "#f6f6f0", // var(--bg-primary)
          secondary: "#ffffff", // var(--bg-secondary)
          tertiary: "var(--background-tertiary)",
        },

        /* Text colors - Enhanced */
        text: {
          primary: "#1e1e1e", // var(--text-primary)
          secondary: "#5a5a5a", // var(--text-secondary)
          light: "#8a8a8a", // var(--text-light)
